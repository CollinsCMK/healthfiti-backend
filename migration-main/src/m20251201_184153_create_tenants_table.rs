        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(string_null(Tenants::City).string_len(100))
                    .col(decimal_null(Tenants::Latitude).decimal_len(10, 8))
                    .col(decimal_null(Tenants::Longitude).decimal_len(11, 8))
                    .col(text(Tenants::DbUrl))
                    ...
                    .col(string_null(Tenants::CountryCode).string_len(5))
